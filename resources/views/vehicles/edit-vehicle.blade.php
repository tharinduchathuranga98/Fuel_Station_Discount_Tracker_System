<x-app-layout>
                            ...
                            <div class="pt-0 card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="owner_name" id="owner_name"
                                            value="{{ old('owner_name', $vehicle->owner_name) }}" class="form-control"
                                            required>
                                        @error('owner_name')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="fuel_type" id="fuel_type" class="form-control select2">
                                            ...
                                            @foreach ($fuelTypes as $code => $name)
                                                <option value="{{ $code }}"
                                                    {{ old('fuel_type', $vehicle->fuel_type) == $code ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-6" id="category-container">
                                        ...
                                        <select name="category" id="category" class="form-control select2">
                                            ...
                                            @foreach ($categories as $code => $name)
                                                <option value="{{ $code }}"
                                                    {{ old('category', $vehicle->category ?? '') == $code ? 'selected' : '' }}>
                                                    {{ $name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="company_name" id="company_name"
                                            value="{{ old('company_name', $vehicle->company_name) }}"
                                            class="form-control">
                                        @error('company_name')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="credit"
                                                {{ $vehicle->status == 'credit' ? 'selected' : '' }}>Credit</option>
                                            <option value="debit" {{ $vehicle->status == 'debit' ? 'selected' : '' }}>
                                                Debit</option>
                                        </select>
                                        @error('status')
                                            <span class="text-danger text-sm">{{ $message }}</span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="text" name="created_at" id="created_at"
                                            value="{{ old('created_at', $vehicle->created_at) }}" class="form-control"
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="mt-3 row">
                                    <div class="col text-center">
                                        ...
                                        <br>
                                        <img src="{{ route('vehicles.qr', $vehicle->id) }}" alt="QR Code"
    ...
    <script>
        $(document).ready(function() {
            ...
            if (selectedFuelType) {
                $('#fuel_type').trigger('change'); // Trigger change event to populate the category dropdown
            }
        });
